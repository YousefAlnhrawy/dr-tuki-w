...
const data = {
    ar: {
        ...
        mangert: "مدير الشركة",
        manager: "المؤسس و الرئيس التنفيذى",
        nameManager : "د. تركي مقبل الجدعاني",
        managerCeo : "المؤسس والمدير العام",
        managerTitle1 : "حاصل على درجة البكالوريوس والماجستير والدكتوراه في القانون من جامعات فرنسية، ويتقن اللغات العربية والفرنسية والإنجليزية، مما يمكنه من تقديم خدمات قانونية احترافية للعملاء المحليين والدوليين.",
        managerTitle2 : "يمتلك خبرة تتجاوز خمسة عشر عاماً في مجال المحاماة والاستشارات القانونية، تشمل على سبيل المثال لا الحصر: قانون الشركات، وقانون الأعمال، والعقود التجارية، والاستثمار، والأحوال الشخصية، والتركات والمواريث، وقانون العمل، وتسوية المنازعات والتحكيم.",
        managerTitle3 : "ويحرص على تقديم حلول قانونية عملية وفعّالة ترتكز على المعرفة القانونية المتخصصة والخبرة المهنية، بما يضمن حماية مصالح العملاء وتحقيق أفضل النتائج.",
    ...
    en: {
        ...
        nameManager : "Dr. Turki M. Aljedani",
        managerCeo : "Founder & Managing Director",
        managerTitle1 : "Holds a Bachelor’s, Master’s, and PhD in Law from French universities, and is fluent in Arabic, French, and English, enabling him to provide professional legal services to both local and international clients.",
        managerTitle2 : "With more than 15 years of experience in legal practice and consultancy, his expertise includes, but is not limited to, corporate law, business law, commercial contracts, investment law, family law, inheritance and estate matters, labor law, dispute resolution, and arbitration.",
        managerTitle3 :"He is committed to delivering practical and effective legal solutions based on specialized legal knowledge and extensive professional experience, ensuring the protection of clients’ interests and the achievement of optimal results.",
    ...
    fr: {
        ...
        manager: "Fondateur et PDG",
        nameManager : "Dr Turki M. Aljedani",
        managerCeo : "Fondateur et Directeur Général",
        managerTitle1 : "Titulaire d’une Licence, d’un Master et d’un Doctorat en droit obtenus auprès d’universités françaises, il maîtrise l’arabe, le français et l’anglais, ce qui lui permet d’accompagner une clientèle locale et internationale avec professionnalisme.",
        managerTitle2 :"Fort de plus de quinze années d’expérience dans le domaine du conseil juridique et du contentieux, il intervient notamment en droit des sociétés, droit des affaires, contrats commerciaux, droit de l’investissement, droit de la famille, successions et héritages, droit du travail, règlement des différends et arbitrage.",
        managerTitle3 :"Il s’attache à proposer des solutions juridiques pratiques et efficaces, fondées sur une expertise juridique approfondie et une solide expérience professionnelle, afin de protéger les intérêts de ses clients et d’obtenir les meilleurs résultats possibles.",
